...
Instances.PhantomTest.Name = "PhantomTest"
...
Instances.mainframe.BackgroundColor3 = Color3.fromRGB(33, 59, 62)
...
Instances.title.BackgroundColor3 = Color3.fromRGB(33, 59, 62)
...
Instances.title.Text = "Phantom Testing"
...
Instances.exec.MouseButton1Click:Connect(function()
    Phantom.schedule_script(Instances.TextBox.Text)
end)
...
/*
std::string phantom_lua_ui = PH_O(R"(
...
MobileBlox.Name = "temp_ui"
MobileBlox.Parent = gethui()
...
local function OBDPHLQ_fake_script() -- Execute.LocalScript
    ...
    btn.MouseButton1Click:Connect(function()
        Phantom.schedule_script(box.Text)
    end)
end
